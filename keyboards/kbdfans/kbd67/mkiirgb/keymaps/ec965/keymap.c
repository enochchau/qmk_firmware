...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
		[0] = LAYOUT_65_ansi_blocker(
		    ...
		    KC_LCTL,       KC_LGUI,  KC_LALT,                KC_SPC,                KC_RALT,           LT(1,KC_APP), KC_LEFT,           KC_DOWN,   KC_RIGHT),
		[1] = LAYOUT_65_ansi_blocker(
			...
			_______,	   RGB_SPI,  RGB_SPD, _______,_______, _______, _______, _______, KC_MPRV, KC_MPLY, KC_MNXT, _______,           _______,  _______,
		    _______,       _______,  _______, _______,_______, _______, _______, KC_MUTE, KC_VOLD, KC_VOLU, _______,  _______,          KC_PGUP,  _______,
		    _______,       LAG_NRM,  LAG_SWP,                  _______,                   _______,          _______,  KC_END,           KC_PGDN,  _______),
};
