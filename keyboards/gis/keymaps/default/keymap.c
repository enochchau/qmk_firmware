...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT( \
        ...
        LT(2,KC_GRV),KC_A,KC_S,   KC_D,    KC_F,   KC_G,             KC_H,    KC_J,    KC_K,    KC_L,   KC_SCLN, KC_QUOT, \
        KC_LSFT, KC_Z,   KC_X,    KC_C,    KC_V,   KC_B,             KC_N,    KC_M,    KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, \
                 KC_LCTRL,KC_LGUI,KC_LALT, KC_ENT, MO(1),            MO(1),   KC_SPC,  KC_RALT, KC_RGUI,KC_RCTRL \
    ),
    [1] = LAYOUT( \
        _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,          KC_F7,   KC_F8,   KC_F9,   _______, KC_MINS, KC_EQL, \
