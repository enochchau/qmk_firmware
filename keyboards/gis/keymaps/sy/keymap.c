...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    MO(_LYCONTROL),KC_A, KC_S,    KC_D,    KC_F,   KC_G,             KC_H,    KC_J,    KC_K,    KC_L,   KC_SCLN, LT(_LYCONTROL,KC_QUOT), \
        KC_LSFT, KC_Z,   KC_X,    KC_C,    KC_V,   KC_B,             KC_N,    KC_M,    KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, \
                 KC_LALT,KC_LGUI, KC_LCTRL,MO(_LYMOD),KC_ENT,        KC_SPC,  MO(_LYMOD),KC_RCTRL,KC_RGUI,KC_RALT \
    ),
    [_LYCONTROL] = LAYOUT( \
        RESET,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,          KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11, \
        _______, _______, _______, KC_HOME, KC_PGUP, _______,        _______, KC_F12,  KC_PAUS, KC_SCRL, KC_PSCR, KC_BSLS,\
